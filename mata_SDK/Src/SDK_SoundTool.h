...
namespace SDK {
	...
	public:
		...
		void SetPlaySpeed(SDK::MultiSoundChannel& ChannelVar, float Speed);
		void SetVolume(SDK::SoundChannel& ChannelVar, float Volume);
		void SetVolume(SDK::MultiSoundChannel& ChannelVar, float Volume);
		void SetPlayTime(SDK::SoundChannel& ChannelVar, float Time);
		void ResetPlaySpeed(SDK::SoundChannel& ChannelVar);
		void ResetPlaySpeed(SDK::MultiSoundChannel& ChannelVar);
