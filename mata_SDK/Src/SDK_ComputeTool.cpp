...
MSDK::SDK_ComputeTool MSDK::ComputeTool;

void MSDK::SDK_ComputeTool::ComputeMatrix(glm::mat4& Dest, glm::mat4& Matrix1, glm::mat4& Matrix2, glm::mat4& Matrix3, glm::mat4& Matrix4, glm::mat4& Matrix5) {
