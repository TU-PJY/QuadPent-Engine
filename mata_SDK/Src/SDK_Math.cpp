...
void SDK_Math::LookAt(GLfloat& DestRotation, GLfloat FromX, GLfloat FromY, GLfloat ToX, GLfloat ToY, GLfloat RotationSpeed, float FrameTime) {
...
void SDK_Math::LookAt(GLfloat& DestRotation, glm::vec2& Position1, glm::vec2& Position2, GLfloat RotationSpeed, float FrameTime) {
	GLfloat TargetAngle{}, ShortestAngle{};
...
void SDK_Math::LookAt(GLfloat& RotationDest, GLfloat Rotation, GLfloat RotationSpeed, float FrameTime) {
	GLfloat TargetAngle{}, ShortestAngle{};
...
void SDK_Math::Lerp(GLfloat& DestValue, GLfloat Dest, GLfloat Speed, float FrameTime) {
...
void SDK_Math::Lerp(glm::vec2& DestValue, glm::vec2& Dest, GLfloat Speed, float FrameTime) {
	GLfloat t = Speed * FrameTime;
	SDK::EXTool.ClampValue(t, 1.0, CLAMP_GREATER);
...
void SDK_Math::Lerp(glm::vec3& DestValue, glm::vec3& Dest, GLfloat Speed, float FrameTime) {
	GLfloat t = Speed * FrameTime;
	SDK::EXTool.ClampValue(t, 1.0, CLAMP_GREATER);
...
GLfloat SDK_Math::ComputeDistance(GLfloat FromX, GLfloat FromY, GLfloat ToX, GLfloat ToY) {
	return  std::sqrt(std::pow(FromX - ToX, 2) + std::pow(FromY - ToY, 2));
}

GLfloat SDK_Math::ComputeDistance(glm::vec2& Position1, glm::vec2& Position2) {
	return  std::sqrt(std::pow(Position1.x - Position2.x, 2) + std::pow(Position1.y - Position2.y, 2));
}

glm::vec2 SDK_Math::ComputeMidPoint(glm::vec2& Position1, glm::vec2& Position2) {
	return glm::vec2((Position1.x + Position2.x) / 2.0, (Position1.y + Position2.y) / 2.0);
}

GLfloat SDK_Math::Computedegree(GLfloat FromX, GLfloat FromY, GLfloat ToX, GLfloat ToY) {
	return atan2(ToY - FromY, ToX - FromX) * (180.0 / 3.1415);
}
 
GLfloat SDK_Math::Computedegree(glm::vec2& Position1, glm::vec2& Position2) {
	return atan2(Position2.y - Position1.y, Position2.x - Position1.x) * (180.0 / 3.1415);
}

GLfloat SDK_Math::ComputeRadians(GLfloat FromX, GLfloat FromY, GLfloat ToX, GLfloat ToY) {
	return atan2(ToY - FromY, ToX - FromX);
}

GLfloat SDK_Math::ComputeRadians(glm::vec2& Position1, glm::vec2& Position2) {
...
GLfloat SDK_Math::NormalizeDegree(GLfloat Degree) {
	while (Degree < 0) Degree += 360;
	while (Degree >= 360) Degree -= 360;
	return Degree;
}

GLfloat SDK_Math::ComputeShortestRotation(GLfloat CurrentDegree, GLfloat DegreeDest) {
