...
char* MSDK::SDK_Shader::LoadShaderFile(std::string FileName) {
...
void MSDK::SDK_Shader::LoadVertexShader(std::string VertexShader) {
...
void MSDK::SDK_Shader::LoadFragmentShader(std::string FragmentShader) {
...
void MSDK::SDK_Shader::LoadComputeShader(std::string ComputeShader) {
...
void MSDK::SDK_Shader::CreateShader(GLuint& Shader) {
...
void MSDK::SDK_Shader::CreateComputeShader(GLuint& Shader) {
	Shader = glCreateProgram();
...
void MSDK::SDK_Shader::CreateShaderLocation() {
	// Image Shader
...
void MSDK::SDK_Shader::CreateSSBO() {
