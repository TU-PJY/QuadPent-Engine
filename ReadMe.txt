...
* When distributing an executable file, it must be distributed along with the "MGKResource" folder and other necessary resources. 
  The "MGKResource" folder contains files required to run MGK program.