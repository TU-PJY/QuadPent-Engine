...
namespace QP {
	...
	public:
		...
		void SetBackColor(QP::Color3& Color);
...
// global scope shader
extern QP::ShaderResource IMAGE_SHADER;
extern QP::ShaderResource TEXT_SHADER;
extern QP::ShaderResource SHAPE_SHADER;

// global scope shader location
extern QP::ShaderLocation IMAGE_OPACITY_LOCATION, IMAGE_COLOR_LOCATION, IMAGE_MODEL_LOCATION;
extern QP::ShaderLocation IMAGE_PROJECTION_LOCARION, IMAGE_VIEW_LOCATION, IMAGE_VIEW_POSITION_LOCATION;
extern QP::ShaderLocation BLUR_STRENGTH_LOCATION, BLUR_STATE_LOCATION, BLUR_EXECUTION_LOCATION, CLIPPING_STATE_LOCATION, TEXTURE_SIZE_LOCATION;

extern QP::ShaderLocation TEXT_OPACITY_LOCATION, TEXT_COLOR_LOCATION, TEXT_MODEL_LOCATION;
extern QP::ShaderLocation TEXT_PROJECTION_LOCATION, TEXT_VIEW_LOCATION, TEXT_VIEW_POSITION_LOCATION;

extern QP::ShaderLocation SHAPE_OPACITY_LOCATION, SHAPE_COLOR_LOCATION, SHAPE_MODEL_LOCATION;
extern QP::ShaderLocation SHAPE_PROJECTION_LOCATION, SHAPE_VIEW_LOCATION, SHAPE_VIEW_POSITION_LOCATION;
