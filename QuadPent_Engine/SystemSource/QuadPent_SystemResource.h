...
namespace QP {
	struct QuadPent_SYSTEM_RESOURCE {
		const char* SDK_LOGO_IMAGE_DIRECTORY = "SystemComponent//Image//Common//logo-SDK.png";
		...
		const char* SDK_LOGO_SOUND_DIRECTORY = "SystemComponent//Sound//sound-logo.wav";

		const char* SDK_FONT_DIRECTORY = "SystemComponent//Font//SpaceGrotesk-Regular.ttf";
